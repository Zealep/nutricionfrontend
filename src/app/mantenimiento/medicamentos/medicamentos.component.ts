       ...
       eliminar(row: Medicamento) {
           Swal.fire({
               ...
               if (result.isConfirmed) {
                   await firstValueFrom(this.medicamentoService.delete(row.id!));
                   this.getAll();
